...
pipeline = Pipeline(
    [
        BatchGenerate(
            ...
            outputs=["s3_images"],
            labels=[("stage", "annotation"), ("stage", "seed-gt")],
        ),
        BatchGenerate(
            steps.list_seed_classification_labels,
            outputs=["seed_classification_labels"],
            labels=[("stage", "seed-gt")],
        ),
        ...
        BatchTransform(
            func=steps.fill_ground_truth_from_seed,
            inputs=["seed_classification_labels", "image__ground_truth"],
            outputs=["image__ground_truth"],
            transform_keys=["image_name"],
        ...
        BatchTransform(
            ...
            labels=[("stage", "train"), ("stage", "train-prepare"), ("stage", "seed-gt")],
            transform_keys=["image_name"],
            kwargs=dict(
                primary_keys=["image_name"],
                val_perc=0.25,
        ...
        Train_Tensorflow_ClassificationModel(  # type: ignore[list-item]
            ...
            primary_keys=["image_name"],
            labels=[("stage", "train"), ("stage", "train-without-freeze"), ("stage", "train-tf")],
            model_suffix="_e2e",
        ...
        BatchTransform(
            func=steps.resolve_best_classification_model,
            inputs=["classification_model", "best_classification_model"],
            outputs=["best_classification_model"],
            transform_keys=["classification_model_id"],
            kwargs=dict(model_id_column="classification_model_id"),
            labels=[("stage", "annotation"), ("stage", "train")],
        ),
        BatchTransform(
            func=steps.prediction_to_ls_prediction,
            inputs=["classification_prediction"],
