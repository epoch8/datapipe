...
class FiftyOneImagesDataTableStore(TableStore):
    def __init__(
        ...
        if self.keypoints_skeleton_edges is not None and self.keypoints_labels is None:
            raise ValueError("keypoints_skeleton_edges requires keypoints_labels")
