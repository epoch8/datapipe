...
@dataclass
class SegmentationFreezeDataset:
    input__image: str
    input__image__ground_truth: str
    input__subset__has__image: str
    output__segmentation_frozen_dataset: str
    output__segmentation_frozen_dataset__has__image_gt: str
    working_dir: str
    ...
    segmentation_frozen_dataset_primary_keys: Optional[List[str]] = None
    ...
    def build_compute(self, ds: DataStore, catalog: Catalog) -> List[ComputeStep]:
        step = FreezeDatasetStep(
            ...
            output__frozen_dataset=self.output__segmentation_frozen_dataset,
            output__frozen_dataset__has__image_gt=self.output__segmentation_frozen_dataset__has__image_gt,
