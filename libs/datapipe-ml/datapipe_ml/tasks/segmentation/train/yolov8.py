...
def train_yolov8_segmentation(
    ...
    (
        ...
        dt__segmentation_frozen_dataset__class_names,
        dt__segmentation_frozen_dataset__resized_image_file,
        dt__segmentation_frozen_dataset__yolo_txt,
    ) = input_dts

    runtime = YoloTrainRuntimeConfig.from_kwargs(
        kwargs,
        model_table_key="dt__segmentation_model",
        link_table_key="dt__segm_model_is_trained_on_segm_frozen_dataset",
        model_other_primary_keys_key="segmentation_model_other_primary_keys",
        model_id_key="segmentation_model_id__name",
        frozen_dataset_id_key="segmentation_frozen_dataset_id__name",
    )
    ctx = runtime.build_context(
        YoloTrainContext,
        dt__frozen_dataset=dt__segmentation_frozen_dataset,
        dt__train_config=dt__yolov8_train_config,
        dt__class_names=dt__segmentation_frozen_dataset__class_names,
        dt__resized_image_file=dt__segmentation_frozen_dataset__resized_image_file,
        dt__yolo_txt=dt__segmentation_frozen_dataset__yolo_txt,
    )
...
def get_yolov8_segmentation_train_configs(yolov8_train_configs: List[YoloV8_TrainingConfig]):
    yield train_configs_to_dataframe(
        ...
        id_column="segmentation_train_config_id",
        params_column="segmentation_train_config__params",
...
class Train_YoloV8_SegmentationModel(PipelineStep):
    ...
    def build_compute(self, ds: DataStore, catalog: Catalog) -> List[ComputeStep]:
        return build_yolo_compute(
            ds=ds,
            catalog=catalog,
            input__frozen_dataset=self.input__segmentation_frozen_dataset,
            input__frozen_dataset__has__image_gt=self.input__segmentation_frozen_dataset__has__image_gt,
            output__train_config=self.output__yolov8_train_config,
            output__size_for_resize=self.output__segmentation_size_for_resize,
            output__frozen_dataset__class_names=self.output__segmentation_frozen_dataset__class_names,
            output__frozen_dataset__resized_image_file=self.output__segmentation_frozen_dataset__resized_image_file,
            output__frozen_dataset__yolo_txt=self.output__segmentation_frozen_dataset__yolo_txt,
            ...
            frozen_dataset_id__name=self.segmentation_frozen_dataset_id__name,
            ...
            mode=YoloModeSpec(
                ...
                train_config_id_col="segmentation_train_config_id",
                train_config_params_col="segmentation_train_config__params",
                labels_adapter_factory=CustomYOLOV8SegmentatorLabelsFile,
                get_train_configs_func=get_yolov8_segmentation_train_configs,
