...
@dataclass
class DetectionFreezeDataset:
    input__image: str
    input__image__ground_truth: str
    input__subset__has__image: str
    output__detection_frozen_dataset: str
    output__detection_frozen_dataset__has__image_gt: str
    working_dir: str
    ...
    detection_frozen_dataset_primary_keys: Optional[List[str]] = None
    ...
    def build_compute(self, ds: DataStore, catalog: Catalog) -> List[ComputeStep]:
        step = FreezeDatasetStep(
            ...
            output__frozen_dataset=self.output__detection_frozen_dataset,
            output__frozen_dataset__has__image_gt=self.output__detection_frozen_dataset__has__image_gt,
            ...
            labels=self.labels,
            frozen_dataset_primary_keys=self.detection_frozen_dataset_primary_keys,
