...
from datapipe_ml.observability.metrics_schema import build_metric_schema
...
from datapipe_ml.observability.spec_catalog import (
    EntitySourceIndex,
    TrainingLinkContext,
...
class MetricsService:
    ...
    def list_classes(
        ...
        *,
        ...
        primary_vals = [r.model_dump().get(primary) for r in rows]
        primary_vals = [v for v in primary_vals if v is not None]
        macro_f1 = sum(primary_vals) / len(primary_vals) if primary_vals else None
