...
from datapipe_app.observability.schemas import SqlQueryRequest, SqlQueryResponse, SqlSchemaResponse
...
from datapipe_ml.observability.analytics_views import ensure_analytics_tables, get_schema, refresh_analytics_views
from datapipe_ml.observability.metrics_service import MetricsService
from datapipe_ml.observability.ops_spec_routes import register_ops_spec_routes
...
from datapipe_ml.ops_specs_service import OpsSpecsService
...
def register_ml_observability_routes(
    ...
    *,
    ...
    require_agent_pipeline: Callable[[str], None],
) -> None:
    ...
    def evaluate_metrics(
        ...
        require_agent_pipeline(pipeline_id)
    ...
    def run_sql_query(req: SqlQueryRequest) -> SqlQueryResponse:
        ensure_analytics_tables(store.engine, tables=store.ml_tables, schema=store.schema)
