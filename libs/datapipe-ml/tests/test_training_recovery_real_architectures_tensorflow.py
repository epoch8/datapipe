...
from tests.helpers.training_recovery_tensorflow import (
    ...
    real_recovery_tensorflow_cases,
    tensorflow_step_configure,
)
from tests.helpers.training_smoke import run_pipeline

pytestmark = [pytest.mark.slow, pytest.mark.training, pytest.mark.tensorflow]
...
@pytest.mark.parametrize("case", real_recovery_tensorflow_cases())
