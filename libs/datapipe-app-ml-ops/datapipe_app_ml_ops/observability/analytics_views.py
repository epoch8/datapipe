...
def apply_analytics_table_config(
    *,
    tables: MLObservabilityTableConfig,
    schema: str | None,
) -> None:
...
def ensure_analytics_tables(
    engine: Any,
    *,
    tables: Optional[MLObservabilityTableConfig] = None,
    schema: Optional[str] = None,
) -> None:
    tables = tables or MLObservabilityTableConfig()
...
def refresh_analytics_views(
    ...
    *,
    ...
    svc = MetricsService(store=store, ds=ds, catalog=catalog, ops_specs=ops_specs)
