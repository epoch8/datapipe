...
from datapipe_app_ml_ops.image_visualization import OverlayMode, iter_bbox_fields_from_record, render_visualization_bytes
...
from datapipe_app_ml_ops.ops_spec_resolve import resolve_frozen_scope_column
