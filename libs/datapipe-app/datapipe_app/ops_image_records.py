...
from datapipe_app.image_visualization import OverlayMode, iter_bbox_fields_from_record, render_visualization_bytes
...
from datapipe_app.ops_spec_resolve import resolve_frozen_scope_column
...
class OpsImageRecordsSupport:
    ...
    def image_records(
        ...
        *,
        ...
        query_kwargs = self._data_image_query_kwargs(view, search=search, filter_rules=filter_rules, filter_mode=filter_mode)
    ...
    def _data_list_row(
        ...
        *,
        ...
        bbox_count = self._bbox_count(gt_record.get(view.ground_truth.bboxes_column or "bboxes") if gt_record and view.ground_truth else None)
    ...
    def _load_annotation_record(
        ...
        *,
        ...
        if parent_id is not None and model_id_column:
            # only add parent scope key if the annotation table actually has it.
            try:
                ...
                # fallback to primary-key lookup without parent scope
                pass
        if len(lookup) == 1:
    ...
    def _data_image_query_kwargs(
        ...
        *,
        ...
        kwargs: dict[str, Any] = {
            "allowed_columns": self._data_record_filter_columns(view),
            "search": search,
            "filter_rules": filter_rules,
            "filter_mode": filter_mode,
        }
