...
from datapipe_app.observability.schemas import MetricColumnGroup, MetricDefinition, MetricsTableSchema
...
def build_metric_schema(
    ...
    *,
    ...
    # Drop metric defs not present in data unless schema is canonical (keep structure for UI).
