...
from datapipe_app.observability.graph.discovery import build_stage_edges, build_stage_summary
...
def make_app(
    ...
    *,
    ...
    def _has_catalog_metrics() -> bool:
        return any(table_spec.best_metric_column for spec in ops_spec_registry.list() for table_spec in spec.metrics)
